...
/**
 * This class responsible for creating enrolment items views and populating the view with data.
 */
class EnrolmentsAdaptor extends RecyclerView.Adapter<EnrolmentsAdaptor.ViewHolder> {
    ...
    public EnrolmentsAdaptor(EnrolmentsFragment enrolmentsFragment, List<Enrolment> enrolments) {
